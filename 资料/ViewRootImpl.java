...
public final class ViewRootImpl implements ViewParent,
    ...
    public void requestLayout() {
        // 该boolean值变量会在ViewRootImpl.performLayout()开始时设置为true，结束设置为false
        // 表示当前不再Layout过程
    ...
    private void performTraversals() {
        ...
        if (params != null) {
            if ((host.mPrivateFlags & View.PFLAG_REQUEST_TRANSPARENT_REGIONS) != 0 && !PixelFormat.formatHasAlpha(params.format)) {
        ...
        if (mFirst || windowShouldResize || viewVisibilityChanged || params != null || mForceNextWindowRelayout) {
            ...
            if (!mStopped || wasReportNextDraw) {
                ...
                if (focusChangedDueToTouchMode || mWidth != host.getMeasuredWidth() || mHeight != host.getMeasuredHeight() || dispatchApplyInsets || updatedConfiguration) {
                    ...
                    // Ask host how big it wants to be
                    // mWdith&mHeight为Frame宽高，lp为setView传进来的
