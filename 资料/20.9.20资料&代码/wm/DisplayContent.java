...
class DisplayContent extends WindowContainer<DisplayContent.DisplayChildWindowContainer> {
    ...
    private final Consumer<WindowState> mPerformLayout = w -> {
        ...
        if (!gone || !w.mHaveFrame || w.mLayoutNeeded
            ...
            if (!w.mLayoutAttached) {
                ...
                mService.mPolicy.layoutWindowLw(w, null, mDisplayFrames);//here
    ...
    boolean applySurfaceChangesTransaction(boolean recoveringMemory) {
        ...
        do {
            ...
            if (repeats < LAYOUT_REPEAT_THRESHOLD) {
                performLayout(repeats == 1, false /* updateInputWindows */);//here
            } else {
    ...
    void performLayout(boolean initial, boolean updateInputWindows) {
        ...
        mService.mPolicy.beginLayoutLw(mDisplayFrames, getConfiguration().uiMode);//设置屏幕的大小；包括状态栏，导航栏
        if (isDefaultDisplay) {
        ...
        forAllWindows(mPerformLayout, true /* traverseTopToBottom */); // 计算所有父窗口的大小
