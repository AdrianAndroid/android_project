...
public class ExpandableActivity extends AppCompatActivity {
    ...
    private void init() {
        final ExpandableListView elv01 = findViewById(R.id.elv_01);
...
//                boolean isExpand = (boolean) map.get("isExpanded");   //这种是通过tag传值
        ...
        elv01.setOnGroupClickListener((parent, v, groupPosition, id) -> {
            Toast.makeText(this, "组被点击了，跳转到具体的Activity", Toast.LENGTH_SHORT).show();
        ...
        elv01.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition,
                ...
                Toast.makeText(ExpandableActivity.this, "组中的条目被点击：" + classes[groupPosition] + "的" +
