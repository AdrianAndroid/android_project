...
class ServerThread extends Thread {
    ...
    public void run() {
        ...
        InputManagerService inputManager = null; // IMS
        ...
        try {
            ...
            // setSystemProcess:�����system_server���̿ɼӵ�AMS�У�����������
            ...
            // ��settingprovider�ŵ��system_server������������
            ...
            // 1. 新建IMS对象。注意第2个参数wmHandler，这说明IMS的一部分功能可能会在WMS主线程中完成
            inputManager = new InputManagerService(context, wmHandler);

            Slog.i(TAG, "Window Manager");
            // 1. 创建WMS实例
            // 通过WindowManagerServicede的静态函数main()创建WindowManagerService实例
            // 注意main函数的两个参数wmhandler和uiHandler。这两个Handler分别运行于由
            // ServerThread所创建的两个名为"WindowMaagner“和UI的两个HanderThread中
            ...
            // 设置IMS给DisplayManagerService。DisplayManagerService将会把屏幕的信息发送给输入系统作为事件加工的依据
            // 在5.2.4节将会讨论到这些信息的作用
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            try {
                ...
                // 创建一个StatusBarManagerService的实例，并注册到ServiceManager中使其成为一个系统服务
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
                ...
                // 调用startSystemUi
                if (!headless) startSystemUi(contextF); //���systemui����ˣ�״̬����׼������
                try {
                ...
                Watchdog.getInstance().start(); //���watchdog
                // �������������systemready����
