...
static int int_register_android_os_Binder(JNIEnv* env)
{
    ...
    // gBinderOffsets是一个静态类对象，它专门保存Binder类的一些在JNI层中的使用的信息，
...
{
    jclass clazz;
    // 根据kBinderInternalPathName的全路径名找到代表该类的jclass对象。全路径名为"com/android/internal/os/BinderInternal"
...
static int int_register_android_os_BinderProxy(JNIEnv* env)
{
    ...
    // 3 gBinderProxyOffsets用来和BinderProxy类打交道
...
int register_android_os_Binder(JNIEnv* env)
{
    ...
    gLogOffsets.mLogE = env->GetStaticMethodID(clazz, "e", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I");
    ...
    gStrictModeCallbackOffsets.mCallback = env->GetStaticMethodID(clazz, "onBinderStrictModePolicyChange", "(I)V");
    LOG_FATAL_IF(gStrictModeCallbackOffsets.mCallback == NULL,"Unable to find strict mode callback.");
    return 0;
}
