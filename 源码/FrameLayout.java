...
public class FrameLayout extends ViewGroup {
    ...
    public FrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FrameLayout, defStyleAttr, defStyleRes);
    ...
    public static class LayoutParams extends MarginLayoutParams {
         ...
         * @attr ref android.R.styleable#FrameLayout_Layout_layout_gravity
         */
        @InspectableProperty(name = "layout_gravity", valueType = InspectableProperty.ValueType.GRAVITY)
