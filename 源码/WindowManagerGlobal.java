...
public final class WindowManagerGlobal {
    ...
    public void addView(View view, ViewGroup.LayoutParams params,
        ...
        // 1. 如果当前窗口需要被添加为另一个窗口的附属窗口（子窗口），则需要让父窗口自己的情况
        ...
        synchronized (mLock) {
            ...
            // 2 创建一个ViewRootImpl对象并保存在root变量中
            ...
            index--;
            // 3。 将作为窗口的控件、布局参数以及新建的ViewRootImpl以相同的索引值保存在三个数组中。
            // 到这步位置，我们可以认为完成了窗口信息的添加工作
            mViews[index] = view;
            mRoots[index] = root;
        ...
        try {
            // 4。 将作为窗口的控件设置给ViewRootImpl。这个动作将导致ViewRootImpl向WMS添加新的
            // 窗口】申请Surface以及托管控件在Surface上的重绘动作。这才是真正意义上完成了窗口的添加操作
    ...
    public void updateViewLayout(View view, ViewGroup.LayoutParams params) {
        ...
        synchronized (mLock) {
            ...
            // 更新布局参数到数组中
            mParams[index] = wparams;
            // 调用ViewRooImpl的setLayotuparams使得新的布局参数生效
