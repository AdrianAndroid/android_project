...
class WallpaperManagerService extends IWallpaperManager.Stub {
    ...
    boolean bindWallpaperComponentLocked(ComponentName componentName, boolean force,
        ...
        try {
            ...
            if (componentName != null && !componentName.equals(IMAGE_WALLPAPER)) {
                ...
                List<ResolveInfo> ris = mIPackageManager.queryIntentServices(intent,
            ...
            intent.putExtra(Intent.EXTRA_CLIENT_INTENT, PendingIntent.getActivityAsUser(
                    mContext, 0,
                    Intent.createChooser(new Intent(Intent.ACTION_SET_WALLPAPER), mContext.getText(com.android.internal.R.string.chooser_wallpaper)),
    ...
    void detachWallpaperLocked(WallpaperData wallpaper) {
        if (wallpaper.connection != null) {
            ...
            try {
                if (DEBUG) Slog.v(TAG, "Removing window token: " + wallpaper.connection.mToken);
