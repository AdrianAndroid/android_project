 ...
 * default style for an {@link android.widget.ExpandableListView} provides indicators which
 * will be shown next to Views given to the {@link android.widget.ExpandableListView}. The
 ...
 * for indicators.
 * <p>
 * The context menu information set by an {@link android.widget.ExpandableListView} will be a
 * {@link android.widget.ExpandableListView.ExpandableListContextMenuInfo} object with
 * {@link android.widget.ExpandableListView.ExpandableListContextMenuInfo#packedPosition} being a packed position
...
public class ExpandableListView extends ListView {
    ...
    private boolean isRtlCompatibilityMode() {
        ...
        return targetSdkVersion < VERSION_CODES.JELLY_BEAN_MR1 || !hasRtlSupport();
    }
    ...
    private boolean hasRtlSupport() {
        return getContext().getApplicationInfo().hasRtlSupport();
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int saveCount = 0;
        final boolean clipToPadding = (mGroupFlags & ViewGroup.CLIP_TO_PADDING_MASK) == ViewGroup.CLIP_TO_PADDING_MASK;
        if (clipToPadding) {
    ...
    public interface OnGroupClickListener {
         ...
         */
        boolean onGroupClick(android.widget.ExpandableListView parent, View v, int groupPosition,
                             long id);
    }
    ...
    public interface OnChildClickListener {
         ...
         * @return True if the click was handled
         */
        boolean onChildClick(android.widget.ExpandableListView parent, View v, int groupPosition,
     ...
     * {@link ExpandableListAdapter} or {@link android.widget.ExpandableListView} method can
    ...
    /**
     * Extra menu information specific to an {@link android.widget.ExpandableListView} provided
     * to the
    ...
    public static class ExpandableListContextMenuInfo implements ContextMenu.ContextMenuInfo {
         ...
         * will be one of the children Views of this {@link android.widget.ExpandableListView}.
         */
         ...
         * {@link android.widget.ExpandableListView#getPackedPositionType},
         * {@link android.widget.ExpandableListView#getPackedPositionChild}, and
         * {@link android.widget.ExpandableListView#getPackedPositionGroup} to unpack this.
         */
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link android.widget.ExpandableListView#onSaveInstanceState()}
         */
        SavedState(
