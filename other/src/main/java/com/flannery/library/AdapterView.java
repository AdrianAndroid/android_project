...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
     ...
     * @see #checkFocus()
     */
    private int mDesiredFocusableState = View.FOCUSABLE_AUTO;
    ...
    public AdapterView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (mDesiredFocusableState == View.FOCUSABLE_AUTO) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(android.widget.AdapterView<?> parent, View view, int position, long id);
    }
     ...
     */
    public void setOnItemClickListener(@Nullable android.widget.AdapterView.OnItemClickListener listener) {
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(android.widget.AdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(android.widget.AdapterView<?> parent, View view, int position, long id);
     ...
     * @param listener The callback that will run
     */
    public void setOnItemSelectedListener(@Nullable android.widget.AdapterView.OnItemSelectedListener listener) {
...
//    @android.view.RemotableViewMethod
    ...
    public void setFocusable(int focusable) {
        ...
        if ((focusable & (View.FOCUSABLE_AUTO | View.FOCUSABLE)) == 0) {
            mDesiredFocusableInTouchModeState = false;
        }

        super.setFocusable((!empty || isInFilterMode()) ? focusable : View.NOT_FOCUSABLE);
    }
    ...
    public void setFocusableInTouchMode(boolean focusable) {
        ...
        if (focusable) {
            mDesiredFocusableState = View.FOCUSABLE;
        }
    ...
    void checkFocus() {
        ...
        super.setFocusable(focusable ? mDesiredFocusableState : View.NOT_FOCUSABLE);
        if (mEmptyView != null) {
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (android.widget.AdapterView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                android.widget.AdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (android.widget.AdapterView.this.getAdapter().hasStableIds()) {
                ...
                mInstanceState = android.widget.AdapterView.this.onSaveInstanceState();
            }
    ...
    public boolean dispatchPopulateAccessibilityEventInternal(AccessibilityEvent event) {
        ...
        if (selectedView != null && selectedView.getVisibility() == View.VISIBLE
