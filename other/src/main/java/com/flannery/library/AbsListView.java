package com.flannery.library;//import android.annotation.ColorInt;
...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    private int[] getDrawableStateForSelector() {
        ...
        // states.
        final int enabledState = View.ENABLED_STATE_SET[0];
    ...
    private boolean shouldDisplayEdgeEffects() {
        return getOverScrollMode() != View.OVER_SCROLL_NEVER;
    }
    ...
    private class FlingRunnable implements Runnable {
        ...
        void edgeReached(int delta) {
            ...
            final int overscrollMode = getOverScrollMode();
            if (overscrollMode == View.OVER_SCROLL_ALWAYS ||
                    (overscrollMode == View.OVER_SCROLL_IF_CONTENT_SCROLLS && !contentFits())) {
                mTouchMode = TOUCH_MODE_OVERFLING;
    ...
    protected void onDisplayHint(int hint) {
        ...
        mPopupHidden = hint == View.INVISIBLE;
    }
